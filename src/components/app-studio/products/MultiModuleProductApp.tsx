...
import type { StudioAppSpec, StudioEntity, StudioRole, StudioScreen } from "@/lib/app-studio/types";
  ...
  return (
    ...
    >
      <header className="z-30 shrink-0 border-b border-border bg-card/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-2 px-3 py-2.5 md:px-5">
          <div className="min-w-0">
            ...
            <p className="truncate text-[11px] text-muted-foreground">
              {spec.tagline} · multi-role demo · mock APIs
            </p>
          </div>
        ...
        {role && (
          <div className="border-t border-border/50 bg-accent-teal/5 px-3 py-1.5 text-xs text-muted-foreground md:px-5">
            ...
            {workflowsForRole[0] && (
              <span className="hidden sm:inline">
                {" "}
                · Try: <strong>{workflowsForRole[0].name}</strong>
              </span>
            )}
          </div>
        )}
      ...
      <footer className="shrink-0 border-t border-border px-4 py-2 text-center text-[10px] text-muted-foreground">

...
export const SITE_FAQ_CATEGORIES: SiteFaqCategory[] = [
  {
    id: "general",
    title: "General",
    description: "What Verlin Labs is and who it's for",
    items: [
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "You'll receive a follow-up email within 1–2 business days with a summary, key frameworks, and suggested next steps for your track.",
        bullets: [
      ...
      },
      {
        ...
        answer:
          "Availability depends on the calendar — weekdays typically have more open times than weekends. Book through the Free Session page and you'll see real-time slots. Confirmation is immediate, with a calendar invite by email.",
      },
    ],
  },
  {
    ...
    items: [
      {
        question: "What's the difference between the three tracks?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Completing the full program includes a Verlin Labs completion certificate and capstone presentation. The free introductory session does not include a certificate — it's an experience session to help you decide if the full track fits.",
      },
      {
        question: "Can I switch tracks later?",
        answer:
          "If you realize another track is a better fit, contact us before the program advances too far. We'll help you move when pacing and content overlap allow. Starting with the free session is the best way to confirm your track before enrolling.",
      },
    ],
  },
  {
    ...
    description: "How we teach and what you'll use",
    items: [
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Yes. We can adapt modules, case studies, and pacing for your industry and skill mix. Share your context through the contact form and we'll propose a structure that fits.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "Sessions are scheduled in India Standard Time (IST) by default, with slots designed for learners in India and compatible regions. If you're in another time zone, mention it when booking or contacting us — we'll suggest the best available options.",
      },
      {
        question: "How are the sessions conducted?",
        answer:
          "Online via video conferencing. You'll receive a link after booking. A laptop or tablet with stable internet is recommended. Camera and microphone are optional but helpful for interaction.",
      },
      {

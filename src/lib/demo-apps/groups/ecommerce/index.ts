...
export const CATEGORIES: DemoCategoryDef[] = [
{
    ...
    tagline: "Search. Shop. Deliver. Return.",
    description:
      "Amazon-structure marketplace: top utility bar (logo, deliver-to, search, Account & Lists, Returns & Orders, Cart), department strip (All + categories), home rails, search/browse with filters, product detail, cart, checkout, orders/returns, wish list, addresses, customer service, and Seller Central. Multi-role: shopper, seller, marketplace ops.",
    examples: ["Amazon", "Amazon.in", "Flipkart", "eBay"],
    ...
    roles: [
      {
        id: "buyer",
        label: "Shopper",
        description: "Search, cart, checkout, track orders, returns, wish list — Amazon customer path.",
        canCreate: true,
        isDefault: true,
      },
      {
        id: "seller",
        label: "Seller",
        description: "Seller Central: create listings, manage inventory, advance fulfilment.",
        canCreate: true,
        canManage: true,
      },
      {
        ...
        description: "Disputes, reinstate listings, returns desk (A-to-z style).",
        canManage: true,
      },
      {
        id: "support",
        label: "Customer service",
        description: "Help with orders, refunds, and account issues.",
        canManage: true,
      },
    ],
    entities: [
    ...
    modules: [
      { id: "home", title: "Home", type: "dashboard", description: "Amazon-style home: deals, category cards, recommended" },
      { id: "search", title: "Search & browse", type: "list", entityId: "product", description: "Results + left filters (department, delivery)" },
      { id: "pdp", title: "Product detail", type: "detail", entityId: "product", description: "PDP · Add to Cart · Buy Now · List" },
      { id: "cart", title: "Cart", type: "list", entityId: "order", description: "Shopping cart · qty · subtotal · Proceed to Buy" },
      { id: "checkout", title: "Checkout", type: "form", entityId: "order", description: "Address · payment · place order" },
      { id: "orders", title: "Your Orders", type: "list", entityId: "order", description: "Track · return · buy again" },
      { id: "returns", title: "Returns Centre", type: "board", entityId: "order", description: "Returns & refunds" },
      { id: "lists", title: "Wish List", type: "list", entityId: "product", description: "Saved items" },
      { id: "account", title: "Your Account", type: "settings", description: "Orders, addresses, lists, sandbox" },
      { id: "addresses", title: "Addresses", type: "form", description: "Deliver-to locations" },
      { id: "customer-service", title: "Customer Service", type: "list", description: "Help hub" },
      { id: "deals", title: "Today's Deals", type: "list", entityId: "product", description: "Deal rail" },
      { id: "departments", title: "All Departments", type: "list", description: "Mega department list" },
      { id: "seller", title: "Seller Central", type: "form", entityId: "product", roleIds: ["seller"], description: "Create listing" },
      { id: "seller-inventory", title: "Inventory", type: "board", entityId: "product", roleIds: ["seller"], description: "Stock & status" },
      { id: "seller-orders", title: "Seller Orders", type: "board", entityId: "order", roleIds: ["seller"], description: "Fulfilment" },
      { id: "ops", title: "Ops desk", type: "board", entityId: "order", roleIds: ["ops", "support"], description: "Disputes & reinstatement" },
    ],
    workflows: [
      {
        id: "wf-buy",
        name: "Shop to door",
        description: "Search → PDP → Cart → Checkout → Track order (Amazon customer path)",
        roleId: "buyer",
        steps: ["Home", "Search", "Product", "Cart", "Checkout", "Orders"],
        moduleId: "checkout",
        entityId: "order",
      },
      {
        id: "wf-return",
        name: "Return item",
        description: "Orders → Start return → Returns Centre",
        roleId: "buyer",
      ...
      },
      {
        ...
        description: "Seller Central → publish listing → inventory",
        roleId: "seller",
        steps: ["Seller Central", "Publish", "Inventory"],
        moduleId: "seller",
        entityId: "product",
      },
      {
        id: "wf-fulfil",
        name: "Fulfil order",
        description: "Seller advances Placed → Shipped → Delivered",
        roleId: "seller",
        steps: ["Seller Orders", "Advance status"],
      ...
      },
      {
        id: "wf-ops",
        name: "Ops reinstate",
        description: "Ops desk: reinstate suspended listings / review returns",
        roleId: "ops",
